...
namespace KineGestion.Data.Migrations
{
    ...
    [Migration("20260915003108_AddBusinessEventTables")]
    partial class AddBusinessEventTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KineGestion.Core.Entities.BillingBatchEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FilterSearch")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<bool?>("OnlyCompletedPending")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("BillingBatchEvents");
                });

            modelBuilder.Entity("KineGestion.Core.Entities.DispatchEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DispatchType", "SentAtUtc");

                    b.ToTable("DispatchEvents");
                });

            modelBuilder.Entity("KineGestion.Core.Entities.DispatchJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SessionId", "DispatchType", "PayloadHash")
                        .IsUnique()
            ...
            modelBuilder.Entity("KineGestion.Core.Entities.Session", b =>
                {
                    ...
                    b.Property<string>("CancellationObs")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.HasIndex("CancellationReason", "FechaHora");

                    b.HasIndex("OfficeId", "FechaHora");

                    b.HasIndex("PaymentStatus", "FechaHora");

                    b.HasIndex("ProfessionalId", "FechaHora");

                    b.HasIndex("Status", "FechaHora");
